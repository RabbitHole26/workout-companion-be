...
const REFRESH_TOKEN_EXPIRY_SCHEMA_PROD = Number(process.env.REFRESH_TOKEN_EXPIRY_SCHEMA_PROD)
// * token expiry - DEV
...
const REFRESH_TOKEN_EXPIRY_SCHEMA_DEV = Number(process.env.REFRESH_TOKEN_EXPIRY_SCHEMA_DEV)
